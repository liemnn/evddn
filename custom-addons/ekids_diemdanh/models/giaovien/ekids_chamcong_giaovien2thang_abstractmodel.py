...
class ChamCongGiaoVien2ThangAbstractModel(models.AbstractModel):
            ...
            if self:
                ...
                if giaovien2thang:
                    if field_value == "2" or field_value=='3':
                        ...
                        giaovien_util.func_tao_macdinh_diemdanh_ca2ngay_theo_ngay_giaovien(self,giaovien2thang.giaovien_id.id,day)
    ...
    def func_mo_popup_chamcong_giaovien2ngay(self, giaovien_id, ngay,trangthai):
        ...
        if giaovien2ngay:
            giaovien_util.func_tao_macdinh_diemdanh_ca2ngay_theo_ngay_giaovien(self,giaovien_id,ngay)
