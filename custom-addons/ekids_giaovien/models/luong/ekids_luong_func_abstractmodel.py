...
class LuongFuncAbstractModel(models.AbstractModel):
    ...
    def action_view_khoitao_luong_giaovien(self):
        ...
        coso_chonghi_truluongs = nghile_util.func_get_nghiles_trong_khoang_thoigian(self, coso, '2', ngay_dauthang,
                                                                          ngay_cuoithang)
        ...
        if giaoviens:
            for giaovien in giaoviens:
                ...
                dl_chamcong = giaovien_util.func_get_dulieu_chamcong_thucte_giaovien(self
                                                                                     ...
                                                                                     ,nam
                                                                                     ,thang)
                self.func_tao_macdinh_luong_cho_giaovien(coso_nghiles
                                                         ,coso_chonghi_truluongs
                                                         ,coso_chonghis
                                                         ,giaovien
                                                         ,nghiles_all
                                                         ,nghipheps
                                                         ,coso_dilam_kehoachs
                                                         ,dl_chamcong,ngay_dauthang_thucte
                                                         ,False)
    ...
    def func_get_parameters(self,coso_nghiles,coso_chonghi_truluong,coso_chonghis,giaovien,luong,nghipheps,coso_dilam_kehoachs,dl_chamcong,nam,thang):
        ...
        dilam_muon = dl_chamcong['dilam_muon']
        dilam_nuabuoi = dl_chamcong['dilam_nuabuoi']
        dilam_nghi= dl_chamcong['dilam_nghi']
        dilam_chamcong = dl_chamcong['dilam_chamcong']
